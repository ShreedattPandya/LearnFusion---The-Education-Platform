    ...
    <section className="home">
      <div className="hero">
        <div className="leftSide">
          ...
          <p>
          Learn, Grow, Succeed!
          Unlock your potential with our wide range of expert-designed courses and engaging quizzes. Whether you're a student, professional, or lifelong learner, we have something for you!
          </p>
      ...
      <div className="footer">
        <div className="parentFooter">
          <div className="box11">
            <div className="logo">
              <h1 onClick={() => navigate("/")}>LearnFusion</h1>
        ...
        <div className="childFooter">
          <h4>Copyright © 2022 LearnFusion (The Professional Academy) All rights reserved</h4>
